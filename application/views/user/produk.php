          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav  mx-auto ">
              ...
              <li class="nav-item active">
                <a class="nav-link" href="<?php echo site_url('user/produk');?>">Menu<span class="sr-only">(current)</span> </a>
              </li>
              <li class="nav-item">
    ...
    <div class="container">
      ...
      <div class="filters-content">
        <div class="row grid">
          ...
          <div class="col-sm-6 col-lg-4 mb-4 all minuman">
            <div class="box">
              <div>
                <div class="img-box">
                  <img src="<?php echo base_url(); ?>uploads/<?php echo $item->gambar; ?>" alt="">
                </div>
                <div class="detail-box">
                  ...
                  <div class="options">
                    <h6>
                      Rp. <?php echo $item->harga_menu;?>
                    </h6>
                    <a href="<?php echo site_url('user/addToCart/'.$item->id_menu);?>">
