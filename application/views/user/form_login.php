...
<div class="login-box">
  ...
  <div class="login-logo mt-3" style="margin-bottom:">
    ...
    <?= $this->session->flashdata('message'); ?>
      <form class="signin-form" action="<?php echo site_url('Login/aksi_login_user');?>" method="POST">
      ...
      <?= form_error('username', '<small class="text-danger pl-3">', '</small>'); ?>
        ...
        <div class="row">
          ...
          <a href="<?php echo site_url('user/register');?>" style="display: inline-block; text-align: center; width: 100%;">Don't have account?</a>
          </div>
          <!-- /.col -->
        </div>
      </form> 
