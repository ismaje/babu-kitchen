			...
			<div class="row">
				<div class="col-lg-3 col-md-6">
					<div class="footer-box about-widget">
						...
						<p>We have a passion for plants and the joy and happiness they bring, but we also see plants as a critical piece of any commercial design. </p>
					</div>
				</div>
				<div class="col-lg-3 col-md-6">
					<div class="footer-box get-in-touch">
						...
						<ul>
							<li>Plosokuning V, Minomartani, Ngaglik</li>
							<li>Indonesia</li>
				...
				<div class="col-lg-6 text-right col-md-12">
					<div class="social-icons">
						<ul>
							...
							<li><a href="https://www.instagram.com/salsasalz_/" target="_blank"><i class="fab fa-instagram"></i></a></li>
