          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <div data-i18n="Account Settings">Shipping Service</div>
              </a>
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="<?php echo site_url('biayakirim');?>" class="menu-link">
                    <div data-i18n="Account">Shipping Cost</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="<?php echo site_url('kota');?>" class="menu-link">
                    <div data-i18n="Notifications">City</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="<?php echo site_url('kurir');?>" class="menu-link">
                    <div data-i18n="Connections">Courier</div>
                  </a>
                </li>
              </ul>
            </li>
