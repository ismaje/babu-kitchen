...
>
  <head>
    ...
    <title>DREAM SHOP - Register</title>
    ...
    <div class="container-xxl">
      ...
      <div class="authentication-wrapper authentication-basic container-p-y">
        <div class="authentication-inner">
          ...
          <div class="card col-20 col-md-20 col-lg-20">
            <div class="card-body">
              <!-- Logo -->
              ...
              <!-- <?php if($this->session->flashdata('msg')): ?>
                ...
                <?php endif ?> -->
                  <form method="POST" action="<?php echo site_url('user/act_reg');?>">
                    <div class="row">
                      <input id="statusAktif" type="hidden" class="form-control" name="statusAktif" value="Y">
                    ...
                    <div class="row">
                      ...
                      <div class="form-group"><h6>Your Home</h6></div>
                    ...
                    <div class="row">
                      ...
                      <select class="form-control selectric" name="kota" tabindex="1" required autofocus>
                        <option>
